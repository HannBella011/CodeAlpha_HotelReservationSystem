...
A desktop GUI application built in Java to manage student profiles, map subject-specific grades, and display interactive academic summary reports. Developed as part of the **CodeAlpha Java Development Internship**.
...
1. Install **JDK 8 or higher** and **Apache Tomcat**.
2. Set up a **MySQL database** with tables for rooms and reservations.
3. Deploy the project on Tomcat and access it via browser.
